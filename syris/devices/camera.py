...
class FPSError(ValueError):
    ...
    """Exception raised when exposure time exceeds 1/FPS."""
...
class Camera(object):
    ...
    def __init__(self, shape, pixel_size, gain, dark_current,
        ...
        specifying \frac{counts}{e^-}, *dark_current* as mean number of
        electrons present without incident light, *amplifier_sigma* is the
    ...
    def get_image(self, photons):
        ...
        $\sigma_y = K \left ( \sigma_e + \sigma_d \right ) + \sigma_q$, where
        $K$ is the system gain, $\sigma_e$ is the poisson-distributed shot
        noise, $\sigma_d$ is the electronics noise and $\sigma_q$ is the
        quantization noise.
        """
